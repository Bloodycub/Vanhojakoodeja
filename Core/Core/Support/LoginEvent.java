...
public final class LoginEvent extends Event implements LoginResponseCodeListener {
	...
	public enum LoginEventResult {
		UNEXPECTED_SERVER_ERROR(1, "Unexpected server error"), LOG_IN(2, "Log in"),
		INVALID_CREDENTIALS(3, "Invalid username or password"), BANNED(4, "Username is banned"),
		...
		PASSWORD_CHANGE_REQUIRED(11,
				"We suspect someone knows your password. Press 'change your password' on the front page."),
		...
		TOO_MANY_INCORRECT_LOGINS(16,
				"Too many incorrect longs from your address. Please wait 5 minutes before trying again."),
		...
		CLOSED_BETA(19,
				"This world is running a closed beta. sorry invited players only. please use a different world."),
		INVALID_LOGIN_SERVER(20, "Invalid loginserver requested please try using a different world."),
		PROFILE_WILL_BE_TRANSFERRED(21,
				"You have only just left another world. your profile will be transferred in 4seconds."),
	...
	private static final Rectangle DISCONECTED = new Rectangle(320, 290, 125, 25);
	...
	private void enterUserDetails() {
		...
		new ConditionalSleep(30_000) {
			@Override
			public boolean condition() throws InterruptedException {
				return getLobbyButton() != null || getClient().isLoggedIn() || getClient().getLoginUIState() == 3
