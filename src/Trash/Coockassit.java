...
public class Coockassit extends Script {
	...
	public static Area Eggs = new Area(3176,3305, 3174,3306);
	Area Wheat = new Area(new int[][] { { 3161, 3291 }, { 3162, 3291 }, { 3163, 3292 }, { 3163, 3295 }, { 3163, 3296 },
			{ 3164, 3297 }, { 3164, 3298 }, { 3164, 3299 }, { 3162, 3302 }, { 3161, 3303 }, { 3160, 3305 },
			{ 3159, 3306 }, { 3157, 3307 }, { 3154, 3307 }, { 3153, 3306 }, { 3153, 3297 }, { 3155, 3295 },
			{ 3157, 3295 }, { 3161, 3291 } });
	...
	Area Chickenspit = new Area(new int[][] { { 3173, 3308 }, { 3180, 3308 }, { 3180, 3304 }, { 3182, 3304 },
			{ 3183, 3303 }, { 3184, 3303 }, { 3186, 3301 }, { 3186, 3299 }, { 3187, 3298 }, { 3187, 3296 },
			{ 3186, 3295 }, { 3186, 3291 }, { 3184, 3289 }, { 3178, 3289 }, { 3177, 3288 }, { 3175, 3288 },
			{ 3174, 3289 }, { 3171, 3289 }, { 3169, 3291 }, { 3169, 3295 }, { 3170, 3296 }, { 3170, 3298 },
			{ 3169, 3299 }, { 3169, 3300 }, { 3173, 3304 }, { 3173, 3307 } });
Areas area = new Areas();
	...
	private void CheckUp() throws InterruptedException {
		...
		} else if (!SellerFULL.contains(myPlayer()) && !LB.contains(myPlayer()) && !inventory.contains("Pot")
				&& !inventory.contains("Bucket") && !Cookroom.contains(myPlayer())) {
	...
	private void Egg() throws InterruptedException {
		...
		GroundItem egg = getGroundItems().closest("egg");
		log("1");
		if(!Areas.Chickenitbig.contains(myPlayer()) && !Eggs.contains(myPlayer())) {
			log("Running to Egg");
			walking.webWalk(Eggs.getRandomPosition());
			sleep(random(1800, 2500));
		}else if ((Egg != null || egg !=null) && Eggs.contains(myPlayer())) {
			log("Taking Egg");
			Egg.interact("Take");
			egg.interact("Take");
