...
public class Lootingbot extends Script {
	 ...
	 Area Lootingarea = new Area(
new int[][]{{ 3217, 3220 },{ 3217, 3227 },{ 3215, 3229 },{ 3215, 3241 },{ 3226, 3243 },{ 3235, 3243 },{ 3242, 3227 },{ 3250, 3227 },
{ 3250, 3224 },{ 3251, 3202 },{ 3237, 3199 },{ 3230, 3199 },{ 3228, 3201 },{ 3228, 3202 },
{ 3227, 3202 },{ 3227, 3204 },{ 3228, 3205 },{ 3228, 3206 },{ 3226, 3208 },{ 3221, 3203 },
{ 3206, 3203 },{ 3207, 3209 },{ 3215, 3209 },{ 3217, 3211 },{ 3217, 3218 } });
...
Area Cappel = new Area(new int[][]{{ 3240, 3216 },{ 3248, 3216 }, { 3248, 3204 },{ 3240, 3204 },{ 3240, 3209 },{ 3238, 3209 },{ 3238, 3212 },{ 3240, 3212 },{ 3240, 3216 }});
...
Area Castle1 = new Area(new int[][]{{ 3227, 3225 },{ 3228, 3226 },{ 3230, 3226 },{ 3231, 3225 }, { 3231, 3221 },{ 3227, 3221 },{ 3227, 3222 },{ 3227, 3225 }});
int Adamantarrow = 0;
int Advalue = 70;
Area Castle2 = new Area(new int[][]{{ 3228, 3217 },{ 3230, 3217 },{ 3231, 3216 },{ 3231, 3213 },{ 3230, 3212 },{ 3228, 3212 },{ 3227, 3213 },{ 3227, 3216 },{ 3228, 3217 }});
Area Gate = new Area(3230, 3220, 3232, 3217); //Lumbgre
int dead = 0;
int runspeed = random(20,37);
    ...
    private void Loot() throws InterruptedException {
    	...
    	if(Cappel.contains(myPlayer()) && !myPlayer().isMoving() && !Cappel.contains(O)){
			log("You in cappel");
			Opencappeldoors();	}
