...
public class PotofFlour extends Script {
	public static Area Mill = new Area(3162, 3311, 3171, 3303);
    ...
    private void CheckUp() throws InterruptedException {
    	if(!inventory.contains("Grain") && !Mill.contains(myPlayer()) &&!inventory.contains("Pot of flour") && inventory.getAmount("Pot") == 14 && !Wheat.contains(myPlayer())) {
    		log("Walking field");
    		WalkingField();
    	}else if(Mill.contains(myPlayer()) && inventory.getAmount("Pot of flour") != 14 && !inventory.contains("Grain") && inventory.contains("Pot")) {
    		log("in mill");
    		gettingFlour();
