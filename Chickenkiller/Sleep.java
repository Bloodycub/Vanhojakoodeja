...
/**
 * Static utility class with various methods that are related to time / Sleep.
 * 
 * @author The Viking
 *
 */
public class Sleep {
	...
	/**
	 * This method waits for a specific condition to be true within a maximum amount
	 * of time. Your basic conditional sleep. This method uses the BooleanSupplier
	 * functional interface, so it provides lambda support
	 * 
	 ...
	 * @return true if the condition was met within the threshold, or false if the
