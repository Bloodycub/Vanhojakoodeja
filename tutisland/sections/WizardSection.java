        ...
        switch (getProgress()) {
            ...
            case 670:
                if (getDialogues().isPendingOption()) {
                    getDialogues().selectOption("Yes.","No, I'm not planning to do that." , "I'm fine, thanks.");
                    sleep(5000);
                    Core.Support.Sleep.waitCondition(() -> getDialogues().isPendingContinuation(), 200,20000);
                    getDialogues().completeDialogue("");
                    tabs.open(Tab.QUEST);
                    sleep(random(600,1500));
                    widgets.interact(629, 27, "Adventure Paths");
